...
RGB_frames = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/crop_images_resize/'
test_frames = 5 
train_frames = 5
test_buffer = 1
train_buffer = 25
...
class sampleReadTrain_RGB(sampleRead):
  ...
  def initialize(self):
    ...
    self.width = 112
    self.path_to_images = RGB_frames 
    self.sample_list = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/5-cross/train5.txt' 
...
class sampleReadTest_RGB(sampleRead):
  ...
  def initialize(self):
    ...
    self.width = 112
    self.path_to_images = RGB_frames 
    self.sample_list = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/5-cross/test5.txt' 
