...
cross = ['1','2','3','4','5']
for i in range(5):
	RGB_video_path = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/2-predict-3/'+cross[i]+'_resize/'
	#RGB_video_path = 'crop_images/'
	SAMPLE_LABEL_PATH='/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/2-predict-3/sample_label_two_'+cross[i]+'.txt'
	#IMAGE_LABEL_PATH='test_four.txt'
	RESULT_LABELS_PATH='../cost-test_result/5-6model_two-'+cross[i]+'-cost1.txt'
