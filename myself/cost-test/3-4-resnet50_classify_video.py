...
cross = ['1','2','3','4','5']
for i in range(5):
	RGB_video_path = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/3-predict-4/'+cross[i]+'_resize/'
	...
	RESULT_LABELS_PATH='../cost-test_result/5-6model_three-'+cross[i]+'-cost1.txt'
